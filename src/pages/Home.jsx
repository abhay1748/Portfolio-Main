        ...
        <>
              ...
              >
                <h1 className="text-[var(--white-primary)] font-bold tracking-[0.6px] text-[33px] sm:text-[40px] sm:text-center md:text-start md:text-[30px] lg:text-[40px] leading-[39px] md:leading-[35px] lg:leading-[40px] md:leading-[36px] lg:leading-[54px]">
                  <GradientText
                    ...
                    tag="h1"
                    text="Hello, I am Abhay Arya,"
                  />
                  Full stack developer based in India
                </h1>
                <p className="text-[var(--white-primary)] text-[13.5px] font-medium tracking-wide sm:text-center md:text-start">
                  If your Looking for a developer who can work on both web and
                  app projects and is willing to try out new roles? or if you
                  need a versatile and motivated developer, feel free to reach
                  out to me.
                </p>
                <div className="flex sm:gap-x-3 gap-y-3 sm:gap-y-0 flex-col sm:flex-row">
                  ...
                  <button className="connectBTN px-6 py-3 rounded-[20px] border-[1px] border-[var(--white-secondary)] z-10 text-[var(--white-primary)] font-semibold tracking-[0.5px] text-[12px] hover:transform">
                    <a href="https://drive.google.com/file/d/19jLG49YZRp1gox3Lf4LnVM9KAyr8yLgb/view?usp=sharing" target="_blanck">
                      SEE MY RESUME
                    </a>
                  </button>
                </div>
          ...
          <section className="mx-auto max-w-7xl pt-20 flex flex-col md:flex-row justify-start  md:items-center md:justify-between px-4 sm:px-10 md:px-8">
            ...
            <div
              ...
              data-aos-duration="4000"
            >
              <p className="text-[var(--white-primary)] text-[17px] font-semibold tracking-wide">
                I am a Full Stack developer, whose passionate about developing
                strong and engaging web and mobile applications.
              </p>
              <p className="text-[var(--white-primary)] text-[12.5px] font-medium tracking-wide">
          ...
          <section className="mx-auto max-w-7xl pt-20 px-4 sm:px-10 md:px-8">
            ...
            >
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-3 md:gap-x-6 pt-5 md:gap-y-6">
                {frontend.map((item) => {
                  return <ImageFrame img={item.logo} name={item.name} />;
                })}
              </div>
            </div>
            <div
          ...
          >
            ...
            <div className="grid gap-y-4 grid-cols-1 md:grid-cols-2 gap-x-4">
              <EducationCard
                ...
                schoolName="Dehradun Institute of Technology"
                schoolLocation="  Dehradun, Uttarakhand, India"
                cardType={1}
              />
              <EducationCard
                duration="2017-2019"
                ...
                degree="Intermediate"
                course="Science"
                schoolName="DPS Panipat City"
                schoolLocation="Panipat, Haryana, India"
                cardType={2}
              />
            </div>
          </section>
