...
function Contact() {
  ...
  const inputDiv = classNames("flex flex-col");
  ...
  const socialsLogo = classNames("w-[30px] h-[30px] text-[#fff] duration-1000");
  ...
  return (
    <section
      id="contact"
      className="md:mx-auto max-w-7xl px-4 sm:px-10 md:px-8 py-10"
    >
      <div
        className="flex flex-col-reverse gap-y-0 md:gap-y-0 md:flex-row items-center justify-between md:items-end relative"
        data-aos="fade-up"
      ...
      >
        <div className="flex flex-col items-center justify-center md:items-start md:justify-start gap-y-5 md:gap-y-4 w-[100%] md:w-[70%]">
          <h1>
            <GradientText
              className="font-bold text-[33px] sm:text-[40px]  md:text-start md:text-[34px] lg:text-[40px] leading-[40px] md:leading-[36px] lg:leading-[54px]"
              tag="span"
              text="Get In Touch"
            />
          </h1>
          <p className="text-[var(--white-primary)] w-[100%] md:w-[80%] lg:w-[70%] text-[13.5px] font-medium tracking-wide text-center  md:text-start">
            Have a project in mind? Looking to partner or work together? Reach
            out through my Social Media links or through the form. I'll get back
            to you in the next 48Hours
          </p>
          <div className="flex items-center gap-x-4">
            <a
              target="_blanck"
              rel="noreferrer"
              href="https://www.linkedin.com/in/abhay-arya-a15603224/"
              className="px-2 py-[7px] bg-[#0e76a9] rounded-[50%] duration-500 ease-in-out hover:cursor-pointer hover:bg-[#000]"
            >
            ...
            <a
              target="_blanck"
              rel="noreferrer"
              href="https://github.com/abhay1748"
              className="px-2 py-[7px] bg-[#333333] rounded-[50%] duration-500 ease-in-out hover:cursor-pointer hover:bg-[#000]"
            >
            ...
            <a
              target="_blanck"
              rel="noreferrer"
              href="mailto: aryaabhay52@gmail.com"
              className="px-2 py-[7px] bg-[#ea4335] rounded-[50%] duration-500 ease-in-out hover:cursor-pointer hover:bg-[#000]"
            >
        ...
        <div className="w-[250px] h-[240px] md:absolute md:right-0 md:-bottom-12">
          <img
            className="w-full h-full rounded-[50%] bg-[#fff] object-cover border-[10px] border-[#b16cea]"
            src={abhay}
            alt="Owner Profile"
          />
        </div>
        ...
        <form className="flex flex-col gap-y-5" ref={form} onSubmit={sendEmail}>
          ...
          <div className={inputDiv}>
            <label className={label}>
              Tell me a bit more about you are looking for?{" "}
            </label>
            <textarea
              name="message"
              onChange={handleOnChange}
          ...
          <button
            className="text-[14px] font-semibold tracking-wide text-[var(--white-primary)] w-fit px-6 rounded-[36px] py-3 bg-gradient-to-r from-[#B16CEA] via-[#FF5E69] via-[#FF8A56] to-[#ffa84b]"
            type="submit"
          >
            SUBMIT NOW
          </button>
